...
I need to start a new QA workflow. Please read the user story from this file:
`user-stories\SCRUM-101-ecommerce-checkout.md`

Summarize into key requirements, acceptance criteria, and testing scope.
...
1. Executive Summary
   ...
   - Overall Pass/Fai1/B10cked status 
...
3. Automated Test Results 
   ...
   - Pass/Fai1 count for each test suite 
...
**Git Repository URL: https://github.com/fola2unde/AI-AGENT-MCP-PLAYWRIGHT-END2END-QA-WORKFLOW.git**
...
5. provide a surmary of what was committed 
...
### Single Combined Prompt(For Demo):
...
tools to manually execute each test scenario. Document findings with screenshots and note any issues discovered. 

STEP 4 - GENERATE AUTC*IATION SCRIPTS: 
...
Create a comprehensive test execution report at: test-results/SCRW4-1ø1-checkout-test-report.md 
